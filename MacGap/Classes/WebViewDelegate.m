...
{
    static const unsigned long long defaultQuota = 50 * 1024 * 1024;
...
//    NSString *lang = [[elementInformation objectForKey:@"WebElementDOMNode"] valueForKey:@"lang"];
//    
//    //NSLog(@"%@", lang);
//    if([lang isEqualToString:@"true"]){
...
//    
//    
//    NSLog(@"Event %lu", [[NSApp currentEvent] type]);
